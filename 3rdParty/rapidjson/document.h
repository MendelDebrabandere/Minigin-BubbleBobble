...
private:
    ...
    enum {
        ...
        kNumberAnyFlag = static_cast<int>(kNumberType) | static_cast<int>(kNumberFlag) | static_cast<int>(kIntFlag) | static_cast<int>(kInt64Flag) | static_cast<int>(kUintFlag) | static_cast<int>(kUint64Flag) | static_cast<int>(kDoubleFlag),
        ...
        kShortStringFlag = static_cast<int>(kStringType) | static_cast<int>(kStringFlag) | static_cast<int>(kCopyFlag) | static_cast<int>(kInlineStrFlag),
        kObjectFlag = static_cast<int>(kObjectType),
        kArrayFlag = static_cast<int>(kArrayType),
